...
public class demo_extentReport extends BasedPage {
	private static final String CODE1 = "{\n    \"theme\": \"standard\",\n    \"encoding\": \"utf-8\n}";
	private static final String CODE2 = "{\n    \"protocol\": \"HTTPS\",\n    \"timelineEnabled\": false\n}";

	@Test
	public void report() {
		ExtentReports extent = new ExtentReports(); // khai bao xu dung extent report
		
		ExtentSparkReporter spark = new ExtentSparkReporter("./report/Automation.html"); // tro report den folder
